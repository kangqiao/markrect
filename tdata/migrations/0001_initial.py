# Generated by Django 2.0.2 on 2018-06-03 16:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('task_timeout', models.IntegerField(default=604800, verbose_name='校勘任务自动回收时间（秒）')),
            ],
            options={
                'verbose_name': '配置',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('text_ready', models.BooleanField(default=False, verbose_name='是否有龙泉藏经经文')),
            ],
            options={
                'verbose_name': '龙泉藏经卷',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('used_in_collation', models.BooleanField(default=True, verbose_name='是否用于校勘')),
            ],
            options={
                'verbose_name': '实体卷',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bar_line_count', models.CharField(default='0', max_length=256, verbose_name='每栏文本行数')),
            ],
            options={
                'verbose_name': '实体藏',
        ...
        migrations.CreateModel(
            name='ReelOCRText',
            fields=[
                ('reel', models.OneToOneField(editable=False, on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='tdata.Reel', verbose_name='实体藏经卷')),
